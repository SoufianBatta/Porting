...
Route::get('/HomePage/SocialDex', [PokemonController::class, 'PersonalSocialDex'])->name('SocialDex');
Route::post('/HomePage/SocialDex', [PokemonController::class, 'SocialDex'])->name('SocialDex');